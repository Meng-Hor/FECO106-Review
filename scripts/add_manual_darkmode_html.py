...
def update_html(filepath):
    ...
    # Find the dropdown and append the button right after it
    ...
    # Now update the Javascript block
    old_js = r'<script>.*?// Theme Switcher Logic.*?</body>'
    ...
    new_js = '''<script>
        ...
        // Load saved mode or OS preference
...
print("Added mode toggle button and JS to HTML")
