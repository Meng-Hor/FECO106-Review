...
questions = [
    ...
    },
    {
        ...
        "options": ["32, 8, 2", "32, 12, 2", "48, 8, 2", "32, 8, 3"],
        "correctOption": 1,
    ...
    },
    {
        ...
        "options": ["192.168.1.25", "192.168.1.19", "192.168.1.20", "192.168.1.33"],
        "correctOption": 1,
...
import os
path = r'C:\Users\Ly Meng Hor ING\Documents\Lesson-Review\web\sets\Networking_IPv4_Subnetting\data.js'
with open(path, 'w', encoding='utf-8') as f:
    f.write(js_content)

print("Rewrote IPv4 subnetting to Multiple Choice")
